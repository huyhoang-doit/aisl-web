  ...
  useEffect(() => {
    ...
    const fetchDetail = async () => {
      ...
      try {
        ...
        const detail = (res?.data ?? res) as NotificationMessage;
        ...
        console.error("Failed to fetch user notification detail:", error);
      ...
      <div className="bg-card rounded-lg border shadow-sm p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-4 border-t mt-8">
            <p className="text-sm text-muted-foreground italic">Thông báo này được gửi tự động từ hệ thống.</p>
          </div>
        </div>
      </div>
    </div>
