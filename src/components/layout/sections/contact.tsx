...
export const ContactSection = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const mailToLink = `mailto:Dotntse181697@fpt.edu.vn?subject=${subject}&body=Hello I am ${firstName} ${lastName}, my Email is ${email}. %0D%0A${message}`;
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <div className="text-muted-foreground">SEP490-Lockerly Team</div>
            </div>
