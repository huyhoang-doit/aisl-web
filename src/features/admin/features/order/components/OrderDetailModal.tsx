              ...
              <section>
                ...
                {order.orderType === "LOGISTICS" && (
                  <section>
                    ...
                    <div className="bg-blue-500/5 dark:bg-blue-500/10 border border-blue-200/50 dark:border-blue-800/50 rounded-lg p-4 flex items-center justify-between shadow-sm">
                      <div className="flex flex-col items-center gap-1 flex-1">
                        <div className="h-10 w-10 rounded-full bg-background border-2 border-blue-500/30 flex items-center justify-center text-blue-500 shadow-sm">
                          <MapPin className="h-5 w-5" />
                        </div>
                        <span className="text-xs font-bold text-blue-600 dark:text-blue-400">GỬI TẠI</span>
                      ...
                      <div className="flex-1 flex flex-col items-center">
                        <div className="relative w-full flex items-center justify-center">
                          <div className="h-[2px] bg-blue-500/20 w-full absolute top-[50%]"></div>
                          <ArrowRight className="h-5 w-5 text-blue-500 bg-background relative z-10 px-0.5 rounded-full border border-blue-500/20" />
                        </div>
                        <span className="text-[10px] text-blue-500 mt-1 font-bold">
                          {EnumTranslator.translateLogisticsType(order.logisticsType || "")}
                        </span>
                      </div>

                      <div className="flex flex-col items-center gap-1 flex-1">
                        <div className="h-10 w-10 rounded-full bg-background border-2 border-green-500/30 flex items-center justify-center text-green-500 shadow-sm">
                          <MapPin className="h-5 w-5" />
                        </div>
                        <span className="text-xs font-bold text-green-600 dark:text-green-400">NHẬN TẠI</span>
                        <span className="text-[10px] font-bold text-center">
                ...
                {order.orderType === "PERSONAL_RENTAL" && (
                  <section>
                    ...
                    <div className="bg-orange-500/5 dark:bg-orange-500/10 border border-orange-200/50 dark:border-orange-800/50 rounded-lg p-4 shadow-sm">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-background border-2 border-orange-500/30 flex items-center justify-center text-orange-500 shadow-sm shrink-0">
                          <MapPin className="h-5 w-5" />
                        </div>
                        <div>
                          <p className="text-sm font-bold">{cabinetNames[order.rentalCabinetId] || "Tủ thuê cá nhân"}</p>
