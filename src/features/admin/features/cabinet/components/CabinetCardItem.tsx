...
const CabinetCardItem: React.FC<CabinetCardItemProps> = ({ cabinet, onClick }) => {
  ...
  const handleResetSetupClick = (e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  return (
    <>
      ...
      <AlertDialog open={isResetDialogOpen} onOpenChange={setIsResetDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Xác nhận xóa cài đặt</AlertDialogTitle>
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa cài đặt cho cụm tủ{" "}
              <strong>{cabinet.name}</strong>? Thao tác này không thể hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
